...
#set init_lef_file [fill out]
set init_lef_file "$lef ./subckt/sram_w8_160b.lef ./subckt/sram_w8_64b.lef"

# MCMM setup
#create_library_set -name WC_LIB -timing [fill out]
#create_library_set -name BC_LIB -timing [fill out]
create_library_set -name WC_LIB -timing "$worst_timing_lib ./subckt/sram_w8_160b_WC.lib ./subckt/sram_w8_64b_WC.lib"
create_library_set -name BC_LIB -timing "$best_timing_lib ./subckt/sram_w8_160b_BC.lib ./subckt/sram_w8_64b_BC.lib"
