...
set init_lef_file "$lef ./subckt/sram_w8.lef"

# MCMM setup
#create_library_set -name WC_LIB -timing [fill out]
#create_library_set -name BC_LIB -timing [fill out]
create_library_set -name WC_LIB -timing "$worst_timing_lib ./subckt/sram_w8_WC.lib" 
create_library_set -name BC_LIB -timing "$best_timing_lib ./subckt/sram_w8_BC.lib"
